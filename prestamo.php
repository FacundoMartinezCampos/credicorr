    ...
    <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
      ...
      <div class="bg10">
        ...
        <form action="https://credicorr.com.ar/post-form"  method="post">
          ...
          <input type="number" id="celular" class="cont" name="celular" placeholder="Celular" required> <span class="fa fa telefono"></span> <br/>
          
          <input type="text" id="provincia" class="cont" name="provincia" placeholder="Provincia" required> <span class="fa fa provincia"></span> <br/>
          ...
          <input type="submit"  value="SOLICITAR" id="submit_button">
        </div>
        </form>
       </div>
      </div>
