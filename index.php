...
<html lang="es">
  <head>
    <title>Credicorr$ &mdash; Préstamos personales</title>
    
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">    
    <meta name="description" content="Credicorr, préstamos personales a empleados públicos, privados, jubilados y fuerzas"/>
    <meta name="keywords" content="prestamos , préstamos , plata , dinero "/>
    <meta name="robots" content="index"/>
    <meta name="robots" content="follow"/>
    <meta name="google-site-verification" content="Kr4BjwapumdJhW1a6oqmwxgSWjUdU39AGPo2rY0r_Dc" />
...
<section class="faqq">
    <div class="site-section" id="next">
      <div class="container">
        <h1 class="comoprestamo">¿Cómo pedir un préstamo?</h1>
        <div class="row mb-5">
          <div class="col-md-4 text-center" data-aos="fade-up" data-aos-delay="">
            <img src="images/1.png" alt="Free Website Template by Free-Template.co" class="img-fluid w-25 mb-4">
            <h3 class="card-title">Completá el formulario</h3>
            
          </div>
          <div class="col-md-4 text-center" data-aos="fade-up" data-aos-delay="100">
            <img src="images/2.png" alt="Free Website Template by Free-Template.co" class="img-fluid w-25 mb-4">
            <h3 class="card-title">Esperá mientras validamos la información</h3>
            
          </div>
          <div class="col-md-4 text-center" data-aos="fade-up" data-aos-delay="200">
            <img src="images/3.png" alt="Free Website Template by Free-Template.co" class="img-fluid w-25 mb-4">
            <h3 class="card-title">Recibí el dinero en tu cuenta</h3>
     ...
     <div class="preguntaarriba">
        <h1 class="h2 mb-5 text-center comoprestamo frecuentespre">Preguntas frecuentes</h1> 
      </div>
        
        <div class="tab">
          <input id="tab-1" type="checkbox" name="tab">
          <label for="tab-1">¿Cuáles son los pasos para pedir el préstamo?</label>
          <div class="tab-content">
            <p><ul>
              <li>Completá y enviá el formulario.</li>
              <li>Esperá la validación de tus datos.</li>
              <li>Nos contactamos con vos y te depositamos el dinero.</li>
            </ul></p>
          </div>
        </div>
        <div class="tab">
          <input id="tab-2" type="checkbox" name="tab">
          <label for="tab-2">¿Cuáles son los requisitos para pedir un préstamo?</label>
          <div class="tab-content">
            <p><ul>
              <li>Ser mayor de 18 años y residir en argentina.</li>
              <li>Tener algun tipo de ingreso.</li>
              <li>Poseer una cuenta bancaria, que no corresponda a un plan social.</li>
              <li>Completar y enviar el formulario de solicitud de préstamo.</li>
            </ul></p>
          </div>
        </div>
        <div class="tab">
          <input id="tab-3" type="checkbox" name="tab">
          <label for="tab-3">¿Cómo pago el préstamo?</label>
          <div class="tab-content">
            <p>El monto se debita automáticamente todos los meses de tu cuenta.</p>
          </div>
        </div>
        <div class="tab">
          <input id="tab-4" type="checkbox" name="tab">
          <label for="tab-4">¿Cuánto puedo pedir?</label>
          <div class="tab-content">
            <p>Podes pedir hasta $70000</p>
          </div>
        </div>
        <div class="tab">
          <input id="tab-5" type="checkbox" name="tab">
          <label for="tab-5">¿En cuántas cuotas se puede solicitar el préstamo?</label>
          <div class="tab-content">
